...
<div class="mb-6">
    <div class="flex items-center justify-between">
        ...
        <button onclick="console.log('Opening modal'); ProductManager.openModal('modalTambahProduk')" class="px-5 py-3 text-base font-medium text-white bg-orange-500 rounded-lg hover:bg-orange-600 shadow">
            + Tambah Produk
        </button>
    </div>
</div>
