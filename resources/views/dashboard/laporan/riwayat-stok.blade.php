        ...
        products.forEach(product => {
            ...
            row.innerHTML = `
                ...
                <td class="py-4 px-4 text-right">
                    <button onclick="showStockHistory('${type}', '${product.product_id}', '${product.product_name}', '${product.sku}')" class="text-[#3b6b0d] hover:text-[#335e0c] flex items-center gap-1 justify-end w-full">
