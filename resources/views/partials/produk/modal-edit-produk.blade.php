...
<div id="modalEditProduk" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden items-center justify-center p-4">
    <div class="bg-white w-full max-w-4xl rounded-2xl shadow-2xl max-h-[90vh] flex flex-col" onclick="event.stopPropagation()">
        <!-- Header -->
        <div class="p-6 border-b bg-gradient-to-r from-orange-50 to-amber-50 rounded-t-2xl">
        ...
        <div class="overflow-y-auto p-6 space-y-6 flex-1">
            <form id="editProdukForm" enctype="multipart/form-data">
                ...
                <div class="p-6 border border-gray-200 rounded-xl bg-white shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <label class="relative cursor-pointer">
                            ...
                            <div class="p-4 border-2 border-gray-200 rounded-xl peer-checked:border-orange-500 peer-checked:bg-orange-50 transition-all duration-200 hover:border-orange-300">
                ...
                <div class="p-6 border border-gray-200 rounded-xl bg-white shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="editNama" name="name" class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200" placeholder="Contoh: Espresso / Croissant" required>
                        </div>
                        <div>
                            <label class="block font-medium mb-2 text-gray-700" for="editSku">SKU Produk <span class="text-red-500">*</span></label>
                            <input type="text" id="editSku" name="sku" class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200" placeholder="Kode unik produk" required>
                        </div>
                        <div>
                            <label class="block font-medium mb-2 text-gray-700" for="editBarcode">Barcode</label>
                            <div class="flex gap-2">
                                <input type="text" id="editBarcode" name="barcode" class="flex-1 border border-gray-300 rounded-xl px-4 py-3 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200" placeholder="Kode barcode">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="editDeskripsi" name="description" class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200" placeholder="Deskripsi singkat tentang produk..." rows="3"></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="editHarga" name="price" class="w-full border border-gray-300 rounded-xl pl-10 pr-4 py-3 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200" placeholder="0" required>
                            </div>
                        </div>
                        <div>
                            <label class="block font-medium mb-2 text-gray-700" for="editKategori">Kategori <span class="text-red-500">*</span></label>
                            <select id="editKategori" name="category_id" class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200" required>
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                                ...
                                <select id="editBahanBaku" class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200">
                            ...
                            <div>
                                ...
                                <input type="number" id="editJumlahBahan" class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200" placeholder="0.00" step="0.01">
                            </div>
                            <div>
                                <label class="block font-medium mb-2 text-gray-700" for="editSatuanBahan">Satuan</label>
                                <select id="editSatuanBahan" class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200">
                                    <option value="">Pilih Satuan</option>
                                    <!-- Options akan diisi via JavaScript -->
                                </select>
                            </div>
                            <div class="flex items-end">
                                <button type="button" id="editTambahBahanBtn" class="px-4 py-3 bg-orange-600 text-white rounded-xl hover:bg-orange-700 text-sm w-full transition-colors duration-200 font-medium">
                                    + Tambah
                                </button>
                            </div>
                        </div>
                ...
                <div id="editStokSection" class="p-6 border border-gray-200 rounded-xl bg-white shadow-sm transition-all duration-300 hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" id="editStok" name="stock" class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200" value="0">
                        ...
                        <div>
                            ...
                            <input type="number" id="editStokMinimum" name="min_stock" class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200" value="0">
                ...
                <div class="p-6 border border-gray-200 rounded-xl bg-white shadow-sm">
                    ...
                    <select id="editStatus" name="is_active" class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200">
        ...
        <div class="p-6 border-t bg-gray-50 rounded-b-2xl flex justify-between items-center">
            ...
            <div class="flex gap-3">
                ...
                <button type="button" id="btnSimpanEdit" class="px-6 py-3 bg-orange-600 text-white rounded-xl hover:bg-orange-700 font-medium transition-colors duration-200 shadow-sm">
