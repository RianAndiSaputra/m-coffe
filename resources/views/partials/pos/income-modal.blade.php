...
function showIncomeModal(outletId) {
    console.log('showIncomeModal called with outletId:', outletId);
...
function getCurrentOutletId() {
    // Try to get outlet ID from different possible sources
    // 1. From data attribute on a specific element
    ...
    // 3. From localStorage if your app stores it there
...
function fetchRevenueData(outletId) {
    console.log('Fetching revenue data for outlet:', outletId);
