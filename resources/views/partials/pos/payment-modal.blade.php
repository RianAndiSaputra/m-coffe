        ...
        <div class="modal-container bg-white w-full max-w-md mx-auto rounded-xl shadow-lg z-50 overflow-y-auto relative top-1/2 transform -translate-y-1/2">
            <div class="modal-content p-6 text-left">
                ...
                <div class="mb-4">
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center space-x-2 border border-gray-300 p-2 rounded-lg">
                            <input type="radio" name="paymentMethod" value="cash" class="accent-black" checked onchange="toggleCashInput()">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="orderNotes" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400" rows="2"></textarea>
                </div>
        ...
        <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded-lg shadow-lg z-50 overflow-y-auto relative top-1/2 transform -translate-y-1/2">
            <div class="modal-content py-6 text-left px-6">
                ...
                <div class="flex justify-center pt-4 space-x-3">
                    <button onclick="printReceipt()" class="px-5 py-2 text-sm bg-orange-500 text-white rounded hover:bg-orange-600 transition">Cetak Struk</button>
                    <button onclick="closeSuccessModal()" class="px-5 py-2 text-sm bg-gray-200 text-gray-800 rounded hover:bg-gray-300 transition">Tutup</button>
                </div>
            </div>
        </div>
    </div>
